export const ENTITY_SOURCES = Object.freeze({
  cards: Object.freeze({
    ...
    amex_platinum: { urls: ['https://www.americanexpress.com/us/credit-cards/card/platinum/','https://www.americanexpress.com/en-us/credit-cards/credit-intel/platinum-fee/'], required: ['annualFee','earn','bookingEarn','caps.airfare','benefitTags','recurringCredits.hotel_credit','recurringCredits.resy_credit','recurringCredits.digital_entertainment_credit','recurringCredits.lululemon_credit','recurringCredits.uber_one_credit','recurringCredits.oura_credit','recurringCredits.uber_cash','recurringCredits.airline_fee_credit','recurringCredits.saks_credit','recurringCredits.walmart_plus_credit','recurringCredits.equinox_credit','recurringCredits.clear','multiYearCredits.trusted_traveler','hotelStatusByProgram.marriott','hotelStatusByProgram.hilton'] },
    ...
    chase_reserve: { urls: ['https://creditcards.chase.com/rewards-credit-cards/sapphire/reserve','https://www.chase.com/sapphire-cards/personal/reserve'], required: ['annualFee','earn','bookingEarn','benefitTags','recurringCredits.travel_credit','recurringCredits.edit_credit','recurringCredits.dining_credit','multiYearCredits.trusted_traveler'] },
    ...
    venture_x: { urls: ['https://www.capitalone.com/credit-cards/venture-x/','https://www.capitalone.com/credit-cards/travel-and-miles/','https://www.capitalone.com/learn-grow/more-than-money/all-about-venture-x/'], required: ['annualFee','earn','bookingEarn.airfare.capital_one_travel','bookingEarn.hotel.capital_one_travel','benefitTags','recurringCredits.capital_one_travel_credit','annualBonusPoints','multiYearCredits.trusted_traveler'] },
    delta_platinum: { urls: ['https://www.americanexpress.com/us/credit-cards/card/delta-skymiles-platinum-american-express-card/','https://global.americanexpress.com/card-benefits/view-all/delta-platinum'], required: ['annualFee','earn','benefitTags','recurringCredits.rideshare_credit','recurringCredits.resy_credit','recurringCredits.delta_stays_credit','multiYearCredits.trusted_traveler','status.headstart','status.spendDivisor'] },
    delta_reserve: { urls: ['https://www.americanexpress.com/us/credit-cards/card/delta-skymiles-reserve-american-express-card/','https://global.americanexpress.com/card-benefits/view-all/delta-reserve','https://www.americanexpress.com/en-us/credit-cards/credit-intel/delta-reserve-card-benefits/'], required: ['annualFee','earn','benefitTags','recurringCredits.rideshare_credit','recurringCredits.resy_credit','recurringCredits.delta_stays_credit','multiYearCredits.trusted_traveler','status.headstart','status.spendDivisor'] },
