...
const VERIFIER="qp-verify-facts",OPTIMIZER="qp-optimize-shard",OPTIMIZER_SHARDS=32,OPTIMIZER_MAX_SHARDS=256,OPTIMIZER_BATCH=1,OPTIMIZER_PACE_MS=500,MAX_PROFILE_BYTES=250000,MAX_STABILIZATION_PASSES=2;
