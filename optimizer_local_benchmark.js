...
function golden(){return {
 ...
 bookingMethod:{airfare:"direct_airline",hotel:"direct_hotel"},constraints:{maxNewCards:2},aspirations:["travel more","better flights","better hotels"]
};}
...
console.log("QP_LOCAL_BENCHMARK "+JSON.stringify(summary));if(!summary.totalCandidates||summary.maxShardMs>10000)process.exitCode=1;