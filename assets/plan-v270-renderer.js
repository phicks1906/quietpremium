...
function render(data,{demo=false}={}){
  ...
  [['overview','⌂','Overview'],['travel-life','✦','Your New Travel Life'],['airline','✈','Airline Strategy'],['hotel','▰','Hotel Strategy'],['cards','▣','Card Portfolio'],['spend','⌘','Spend Plan'],['benefits','◇','Travel Benefits'],['consider','☆','Consider Cards'],['same','↺','What Stays the Same'],['plan90','◫','90-Day Plan']].map(x=>'<a href="#'+x[0]+'" data-nav="'+x[0]+'"><i>'+x[1]+'</i>'+x[2]+'</a>').join("")+
  '</nav><div class="rail-quote">A more extraordinary tomorrow<br>with the spend you already have.</div></aside>'+
  '<main class="main"><header class="topbar"><button class="mobile-menu" aria-label="Open navigation">☰</button><div class="wordmark">Quiet Premium</div><div class="meta">Your New Travel Life</div></header>'+
  '<section class="hero" id="overview" data-section="overview"><div class="hero-inner"><div class="eyebrow">Same spend. A brighter tomorrow.</div><h1>Your New Travel Life.</h1><p>This is what your existing spending can realistically support: better flights, better airport days, more travel and better stays — with the strategy and mechanics underneath made explicit.</p></div><div class="hero-quote">“A better way<br>to travel.”</div></section>'+
  '<div class="content">'+
  '<section class="section" id="travel-life" data-section="travel-life"><div class="section-head"><div><h2>What Changes for You</h2><p>Travel outcomes first. Cards, status, points and thresholds are only the mechanisms underneath.</p></div></div><div class="life-grid">'+
  lifeCard("/band-air.jpeg","✈","Fly Considerably Better",outcomeCopy("fly",tl.flyBetter))+
  lifeCard("/band-lounge.jpeg","⌁","Make the Airport Part of the Experience",outcomeCopy("airport",tl.airportExperience))+
  lifeCard("/assets/qp-outcome-v210.jpg","☀","Let the Same Spending Pay for More of Your Travel",outcomeCopy("travel",tl.travelCapacity))+
  lifeCard("/band-hotel.jpeg","▰","Stay Considerably Better",outcomeCopy("hotel",tl.stayBetter))+
  '</div></section>'+
  '<section class="section"><div class="strategy-impact"><div class="panel strategy"><h2>Why This Works</h2><div class="sub">The relationships and rewards structure supporting those travel outcomes.</div><div class="strategy-cards">'+
